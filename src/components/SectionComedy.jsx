...
const movies = [
    ...
    {id: 5, image: Movie1, name: 'The Cloud Movie', year: 2012, featured: false},
    {id: 6, image: Movie3, name: 'The Cloud Movie', year: 2011, featured: false},
    {id: 7, image: Movie4, name: 'The Cloud Movie', year: 2022, featured: false}, 
]
